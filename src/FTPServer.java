...
class transferfile extends Thread {
	...
	public void run() {
		while(true) {
			if(FTPServer.readyClients == FTPServer.connectedClients && FTPServer.connectedClients == FTPServer.allowedClients) {
				...
				System.out.println("Waiting for " + (FTPServer.connectedClients - FTPServer.readyClients) + " clients to get ready...");
